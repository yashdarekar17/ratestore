...
import { apiGetStores, apiSubmitRating, apiGetRatings } from "../services/api";
                                ...
                                filteredStores.map((s) => {
                                    ...
                                    return (
                                        <tr key={s.id} className="hover:bg-sky-50/30 transition">
                                            ...
                                            <td className="py-4 px-5">
                                                {myScore > 0 ? (
                                                    <div className="inline-flex items-center gap-1.5 bg-amber-50 border border-amber-200 text-amber-800 px-2.5 py-1 rounded-full text-xs font-semibold">
                                            ...
                                            <td className="py-4 px-5 text-right">
                                                <button
                                                    ...
                                                    className={`inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg text-xs font-semibold transition active:scale-95 cursor-pointer ${myScore > 0
